...
def home(boardname):
    ...
    return render_template('home.html', posts=posts, utcToLocal=utc_to_local, Len=len, allRegex=allRegex, form=form, boardtitle=boards[boardname], boardname=boardname)
