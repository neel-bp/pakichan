...
from flaskblog.forms import (RegistrationForm, LoginForm, UpdateAccountForm,
                             PostForm, RequestResetForm, ResetPasswordForm, SubPostForm)
from flaskblog.models import User, Post, SubPost
...
def new_subpost(post_id):
    ...
    form = SubPostForm()
    if form.validate_on_submit():
        subpost = SubPost(content=form.content.data, author=current_user, post_id=post_id)
